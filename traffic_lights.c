...
LIBRARY: 		traffic_lights.c
						...
						Declares functions for mutually excluding states of traffic lights in	each track, and blinking test for 
						testing all traffic lights, used to ensure all lights are working properly.
